...
# Hard code EDVARKA starting location 
startingLoc = (-3.1609, 55.9518)
...
def main():
    ...
    f = open('firstJourneyStMargaretsLake.geojson', 'w')
    with open('firstJourneyStMargaretsLake.geojson', 'w') as f:
        f.seek(0)
    ...
    centroids_df.to_csv('StMargarets_centroids.csv')
